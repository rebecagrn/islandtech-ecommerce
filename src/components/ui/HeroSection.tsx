...
export default function HeroSection() {
  return (
    <section className="flex flex-col md:flex-row justify-between bg-white/60 backdrop-blur-md rounded-3xl p-8 gap-4 transition-transform duration-300 ease-out hover:shadow-md">
